...
export default function EditPostPage({ params }) {
  ...
  if (loading) {
    return <div className="max-w-3xl mx-auto px-6 py-20 text-center text-sm text-slate-400">불러오는 중…</div>;
  }
  if (err) {
    return (
    ...
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="space-y-5">
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50/40 p-4">
          <p className="text-xs font-semibold text-slate-600 mb-2">발행 상태</p>
          <div className="grid grid-cols-2 gap-2">
            <button type="button" onClick={() => setStatus("draft")}
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-500 leading-relaxed">나만 봄. 목록에서 초안 배지로 표시.</p>
              </div>
            </button>
            <button type="button" onClick={() => setStatus("published")}
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-500 leading-relaxed">모두에게 공개. Obsidian 에 동기화.</p>
              </div>
            </button>
          </div>
        </div>
